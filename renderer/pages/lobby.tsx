...
const Lobby: NextPage = () => {
  ...
  const [selectedPlayers, setSelectedPlayers] = useState<ProfileFile[]>([]);
  ...
  const handlePlayerSelection = (player: ProfileFile) => {
    ...
    if (selectedPlayers.length >= GAME_MAX_PLAYERS) {
      toast.error(
        `The lobby is full! You reached the maximum player capacity of ${
          GAME_MAX_PLAYERS as number
        }. Please remove a player, before you can add ${
          player.name
        } as a player.`,
        {
          ...
          >
            <header className="w-full bg-base-200 p-4">
              ...
              <p className="mb-0">
                ...
                You can select up to {GAME_MAX_PLAYERS} players. Click on a
                player profile to add them the new game.
              </p>
            </header>
                  ...
                  <form onChange={handleSubmit(onSubmit)}>
                    <div className="form-control">
                      ...
                      <select
                        ...
                        {...register("scoreMode")}
                      >
                        {GAME_SCORE_MODES.map((mode: number) => (
          ...
          <div className="drawer-side">
            ...
            <ul className="menu w-80 bg-base-100 p-4 text-base-content">
              <li>
                <Button
                  action={() =>
                    router.push("/profiles/createProfile?from=lobby")
                  }
                  color="ghost"
                >
