...
import { useDisclosure, useFullscreen, useNetwork, useOs } from '@mantine/hooks'
import {
  IconBarbell,
  IconChartBar,
  IconHistory,
...
const DefaultLayout = ({ children, withNavbarOpen = true }: DefaultLayoutProps) => {
        ...
        >
          ...
          <Group gap="lg">
            ...
            <Tooltip label={t('closeApp')} withArrow>
              <ActionIcon c="dimmed" onClick={() => sendIPC('close-app')} variant="transparent">
                <IconSquareX />
              </ActionIcon>
            </Tooltip>
          </Group>
      ...
      <AppShell.Navbar>
        ...
        <AppShell.Section p="lg">
          <Text c="dimmed" ta="center">
            ...
            <Text component="span" fz="xs" display="block">
              {CLIENT_OS.charAt(0).toLocaleUpperCase(locale) + CLIENT_OS.slice(1)}
            </Text>
            <Text component="span" fz="xs" display="block">
